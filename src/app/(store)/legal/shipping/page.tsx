      ...
      <section style={{ padding: '40px 0 100px' }}>
        <div className="container" style={{ maxWidth: '720px', margin: '0 auto' }}>
          <div style={{ color: '#555', lineHeight: 1.8, fontSize: '15px' }}>
            ...
            <p>We ship pan-India. Standard delivery takes 5–7 working days. Express delivery (2–3 days) is available for select pin codes at an additional charge. Orders above ₹2999 qualify for free standard shipping.</p>
            <h2 style={{ fontSize: '20px', fontWeight: 600, color: '#1A1A1A', margin: '32px 0 12px' }}>Returns</h2>
            <p>We accept returns within 30 days of delivery. Items must be unused, unwashed, with all original tags and packaging intact. To initiate a return, email us at labelindeza@gmail.com with your order number.</p>
